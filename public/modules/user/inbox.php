...
if(isset($messages)){
    ...
    <div class="col-md-3" style="background: whitesmoke; border-radius: 10px;text-align: center; padding: 20px;">
        ...
        <a href="sendmessage.php" style="font-size: 20px;"><span class="glyphicon glyphicon-pencil" style="font-size: 20px;"></span> New Message</a>
        <br>
        <a href="sendemail.php" style="font-size: 20px;"><span class="glyphicon glyphicon-list-alt" style="font-size: 20px;"></span> Send Email</a>
        <br>
        ...
        foreach ($messages as $message) {
            if($message!=null){
                ...
                <tr>
                    ...
                    <td><a href='readmessage.php?message_id=<?php echo $message->message_id ?>'>Read</a></td>
                </tr>
                <?php
            }
        }
